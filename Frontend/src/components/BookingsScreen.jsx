      ...
      {bookings.map((booking) => (
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <div>
              <p className="text-gray-400 text-sm font-sans">Booking Ref</p>
              <p className="text-white font-michroma font-semibold">{booking.ref}</p>
            </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <div className="text-center">
                <p className="text-white font-sans font-medium">{booking.from}</p>
              ...
              <div className="text-center">
                <p className="text-white font-sans font-medium">{booking.to}</p>
          ...
          <div className="flex justify-between items-center">
            <p className="text-orange-500 font-michroma font-bold">₹{booking.amount.toLocaleString()}</p>
            <Button
              variant="ghost"
              size="sm"
  ...
  const renderProfile = () => (
    <div className="space-y-4">
      <div className="glass-panel rounded-2xl p-6 text-center">
        ...
        <h3 className="font-michroma font-bold text-xl text-white mb-2">John Doe</h3>
        <p className="text-gray-400 font-sans">john.doe@email.com</p>
        <p className="text-gray-400 font-sans">+91 98765 43210</p>
      </div>

      <div className="glass-panel rounded-2xl p-6">
        <h4 className="font-michroma font-semibold text-lg text-white mb-4">Flight Statistics</h4>
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <p className="text-orange-500 font-michroma font-bold text-2xl">12</p>
            <p className="text-gray-400 text-sm font-sans">Total Flights</p>
          </div>
          <div className="text-center">
            <p className="text-blue-500 font-michroma font-bold text-2xl">850</p>
            <p className="text-gray-400 text-sm font-sans">km Traveled</p>
          </div>
        </div>
      </div>
    </div>
      ...
      case 'payment':
        return (
          <div className="glass-panel rounded-2xl p-6 text-center">
            ...
            <p className="text-white font-sans">Payment methods and billing history</p>
            <Button
              className="mt-4"
      ...
      case 'notifications':
        return (
          <div className="glass-panel rounded-2xl p-6 text-center">
            ...
            <p className="text-white font-sans">Notification preferences and alerts</p>
            <Button
              className="mt-4"
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="font-michroma font-bold text-2xl text-white">Account</h1>
          </div>
          <Button
            variant="ghost"
            size="icon"
          ...
          <div className="grid grid-cols-4 gap-1">
            {tabs.map((tab) => (
              ...
              >
                ...
                <p className="text-xs font-sans">{tab.label}</p>
              </motion.button>
            ))}
          </div>
        </div>
